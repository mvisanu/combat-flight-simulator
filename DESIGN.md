...
Air contacts radar: 290 x 458 panel at (1280,116), with 94% opaque charcoal backing and an antialiased cached range grid. Cyan ring symbols identify same-team friends; solid coral-red diamonds identify foes; a white aircraft silhouette identifies the player. Amber corner brackets supplement the selected enemy's red diamond. The shapes and explicit FRIEND / FOE / YOU / TARGET legend communicate meaning without relying on color. Symbols occupy 28 design units (22.4 pixels at 720p); legend and readouts use 18-unit text. The 2/5/10-mile range buttons have an underline and selected fill. Half/full range rings and the readout use horizontal statute miles. Crowded symbols fan out with leader lines to their actual plot positions; the selected contact receives placement priority. Team affiliation is independent of type/nationality, inactive and destroyed contacts are excluded, and friendly aircraft are discovered when present. The display remains heading up with the player centered. This is a gameplay aid, not an authenticated cockpit instrument.
