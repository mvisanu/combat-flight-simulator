...
Enemy scope: the upper-right HUD shows living enemies within a selectable 2/5/10 statute-mile horizontal radius (default 5), with half/full range rings. Heading up, player centered, selected target amber. This omniscient gameplay aid is inspired by WWII ground-controlled interception displays; it does not simulate onboard radar, terrain masking, identification uncertainty or ground-station coverage.
